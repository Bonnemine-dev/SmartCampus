...
final class Version20231109101004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experimentation (id INT AUTO_INCREMENT NOT NULL, salle_id INT NOT NULL, sa_id INT NULL, datedemande DATETIME NOT NULL, dateinstallation DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_CF9EE405DC304035 (salle_id), UNIQUE INDEX UNIQ_CF9EE40562CAE146 (sa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
